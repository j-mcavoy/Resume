...
\def\personaltag{software generalist with a focus on full-stack development}
\def\previousjob{consultant on the Rowan Apprentice Engineering Team (A-Team)}

\def\previousjobdescription{
...
\def\previousjobexperience{
    ...
    clients. I was the full-stack software lead and led my team to develop a
    suite of web-applications for Rowan's Engineering department, I was in
    charge of setting up DevOps and administering the company's Linux server,
